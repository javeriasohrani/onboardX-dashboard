...
import { Box, Grid, Select, MenuItem, IconButton, FormControl, Card, CardContent, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Fab } from '@mui/material'
        ...
        <Box sx={{ bgcolor: '#F4F5F7', overflow: { md: 'hidden', xs: "auto" } }}>
            ...
            <Grid container sx={{ height: '40%', p: '20px' }}>
                ...
                <Grid item xs={12} md={12} sx={{ height: '70vh', }}>
                            ...
                            <TableContainer className={classes.root} component={Box} sx={{ height: '70vh', width: '100%' }}>
                                <Table stickyHeader={true} size="small">
                                    <TableHead>
                                        <TableRow>
                                            <TableCell>
                                                <Text sx={{ fontSize: '14px' }}> Flow Name</Text></TableCell>
                    ...
                    <Fab onClick={handleFlow} color="primary" aria-label="add" sx={{ position: 'absolute', bottom: { md: 35, xs: 5 }, right: { md: 35, xs: 0 } }}>
                        <AddIcon />
                    </Fab>
                </Grid>
            </Grid>

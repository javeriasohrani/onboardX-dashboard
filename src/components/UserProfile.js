...
function UserProfile() {
  ...
  const getData = async () => {
    const res = await axios
      .get(
        `https://tvrj97vxf0.execute-api.us-east-1.amazonaws.com/dev/employee/${id}`
      )
      .then((res) => {
    ...
    <Box sx={{ height: "auto", backgroundColor: "#F4F5F7" }}>
      <Grid container sx={{ p: "20px" }}>
            ...
            <Grid container xs={12} md={12} sx={{ mt: "2%" }}>
              <Grid item xs={3} md={3}>
                <Stack>
                  ...
                  <Text sx={{ lineHeight: "30px", fontWeight: 300 }}>
                    {data.designation}
                  </Text>
                </Stack>
              </Grid>
        ...
        <Grid
          ...
          xs={12}
          md={12}
          sx={{ backgroundColor: "#ffffff", p: "20px" }}
        >
                ...
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  <Card sx={{ maxWidth: 270 }}>
                    ...
                    <CardContent sx={{ height: "20px" }}>
                      <Text sx={{ fontSize: "16px" }}>Resume</Text>
                    </CardContent>
                  </Card>
                  <Card sx={{ maxWidth: 270, ml: "20px" }}>
                    ...
                    />
                    <CardContent sx={{ height: "20px" }}>
                      <Text sx={{ fontSize: "16px" }}>Cretificate</Text>
                    </CardContent>
                  </Card>

...
const Navbar = () => {
    ...
    return (
        <div>
            <AppBar position="static" sx={{ backgroundColor: '#F4F5F7', boxShadow: 'none', paddingTop: '4px' }}>
                <Toolbar>
                    <Box sx={{ flexGrow: 1 }} />
                    <IconButton
                        size="large"
                            ...
                            >
                                <Stack spacing={2} sx={{ m: '35px' }}>
                                    ...
                                    <Link href='/form' style={{ textDecoration: 'none' }}>
                                        <Text sx={{ fontSize: '14px', color: '#6B778C' }}>Form??????????????</Text>
                                    </Link>
                                    <Link href='/employee' style={{ textDecoration: 'none' }}>
                                        <Text sx={{ fontSize: '14px', color: '#6B778C' }}>Employee??????/</Text>
                                    </Link>
                                    <Link href='/flows' style={{ textDecoration: 'none' }}>
                                        <Text sx={{ fontSize: '14px', color: '#6B778C' }}>Flows</Text>
                                    </Link>
                                    <Link href='#' style={{ textDecoration: 'none' }}>
                                        <Text sx={{ fontSize: '14px', color: '#6B778C' }}>Approval</Text>
                                    </Link>
                                    <Link href='/status' style={{ textDecoration: 'none' }}>
                                        <Text sx={{ fontSize: '14px', color: '#6B778C' }}>Status</Text>
                                    </Link>
                                </Stack>
                            </Box>
                        </Drawer> 

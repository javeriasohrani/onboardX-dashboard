...
export default function AttachmentModal({ key, data, handleSubmit, attach, handleClose }) {
    ...
    const changeAttachHandler = e => {
        ...
        setOld({ ...old, name: e.target.files[0].name, attachment: e.target.files[0] })
    }
    ...
    return (
        <Modal open={attach} onClose={handleClose}>
            <Box sx={style}>
                ...
                <TextField hiddenLabel name="number" onChange={handleAttachSelect } placeholder="Enter Field Name" id="margin-normal" margin="normal" />
                <Heading>Placeholder</Heading>
                <TextField hiddenLabel name="number" onChange={handleAttachSelect } placeholder="Upload your Attachment" id="margin-normal" margin="normal" />

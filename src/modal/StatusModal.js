...
function StatusModal({ open, handleClose }) {
                    ...
                    <Grid container justifyContent='center' alignItems='center'>
                        <Card sx={{ height: "100%", width: '100%', border: "none", boxShadow: "none" }}>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={6} md={6}>
                                        <Stack>
                                            ...
                                            <Text sx={{ fontWeight: 700, fontSize: '14px', color: 'green' }}>Completed</Text>
                                        </Stack>
                                    </Grid>
                                </Grid>
                            </CardContent>
                            <CardActions>
                                ...
                                <Button size="medium" variant="contained" disabled>Notifys</Button>
                            </CardActions>
                        </Card>
                    </Grid>
                </Box>
